...
{
    partial class frmVisRelMultasPendentes
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.multasTableAdapter = new GUI.BibliotecaTableAdapters.MultasTableAdapter();
            ...
            reportDataSource1.Value = this.multasBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "GUI.Relatorios.Multas.Pendentes.RelMultasPendentes.rdlc";
            ...
            this.multasBindingSource.DataSource = this.biblioteca;
            // 
            // multasTableAdapter
            // 
            this.multasTableAdapter.ClearBeforeFill = true;
            // 
            // frmVisRelMultasPendentes
            // 
            ...
            this.Name = "frmVisRelMultasPendentes";
            this.Text = "frmVisRelMultasPendentes";
            this.Load += new System.EventHandler(this.FrmVisRelMultasPendentes_Load);
        ...
        private BibliotecaTableAdapters.MultasTableAdapter multasTableAdapter;
    }
}